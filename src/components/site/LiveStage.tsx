...
function YouTubeIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className={className}>
      <path d="M23.5 6.2.5c-.3-1.2-1.3-2.2-2.5-2.5C19.1 3.5 12 3.5 12 3.5s-7.1 0-9 .9c-1.2.3-2.2 1.3-2.5 2.5C0 8.8 0 12 0 12s0 3.2.5 5.1c.3 1.2 1.3 2.2 2.5 2.5 1.9.9 9 .9 9 .9s7.1 0 9-.9c1.2-.3 2.2-1.3 2.5-2.5.5-1.9.5-5.1.5-5.1s0-3.2-.5-5.1zM9.5 15.5v-7L15.8 12l-6.3 3.5z" />
    </svg>
  );
}
