  ...
  head: () => ({
    meta: [
      { title: "Watch Live — TEXITcoin Honest Money Hour" },
      {
        name: "description",
        content:
          "TEXITcoin goes live with Bobby Gray every Tuesday and Thursday at noon Central. Watch the stream here, or catch the simulcast on X, Facebook and YouTube.",
      },
      { property: "og:title", content: "Watch Live — TEXITcoin Honest Money Hour" },
      {
        property: "og:description",
        content: "Live Tuesdays & Thursdays at noon Central with Bobby Gray.",
      },
          ...
          <div className="mx-auto max-w-6xl grid gap-10 lg:grid-cols-[1fr_1fr]">
            <div>
              ...
              <p className="mt-4 text-muted-foreground">
                ...
                and <strong>Thursdays</strong> at 12:00pm Central. Same format both
