...
const MILESTONES: { date: string; label: string; detail: string }[] = [
  { date: "2022", label: "Genesis", detail: "TEXITcoin mainnet launches — proof-of-work, fair-launch, mined in Texas." },
  { date: "2023", label: "First exchange listing", detail: "TXC lists on centralized exchanges; global on-ramps go live." },
  { date: "2024", label: "honest.money ecosystem", detail: "Swap, wallets, and merchant tools ship under the honest.money umbrella." },
  { date: "2025", label: "Omni Layer 2", detail: "Bitcoin-anchored L2 (Omni) work goes live for tokens and smart contracts." },
  { date: "Now", label: "The Hit List", detail: "We start systematically evaluating every CMC Top 100 project." },
];
