...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "TEXITcoin Next Gen is a modern, light-themed replica of TEXITcoin.org, featuring enhanced blog content." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "TEXITcoin: Layer 1 Currency Mined in Texas" },
      { property: "og:description", content: "TEXITcoin Next Gen is a modern, light-themed replica of TEXITcoin.org, featuring enhanced blog content." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "TEXITcoin: Layer 1 Currency Mined in Texas" },
      { name: "twitter:description", content: "TEXITcoin Next Gen is a modern, light-themed replica of TEXITcoin.org, featuring enhanced blog content." },
