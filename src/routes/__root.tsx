...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "TEXITcoin (TXC) is a Layer 1 cryptocurrency mined in Texas — sound money for a sovereign Lone Star State. Trade on Pionex, track on CoinMarketCap." },
      { name: "author", content: "TEXITcoin" },
      { property: "og:title", content: "TEXITcoin: Layer 1 Currency Mined in Texas" },
      { property: "og:description", content: "TEXITcoin (TXC) is a Layer 1 cryptocurrency mined in Texas — sound money for a sovereign Lone Star State. Trade on Pionex, track on CoinMarketCap." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@texitcoin" },
      { name: "twitter:title", content: "TEXITcoin: Layer 1 Currency Mined in Texas" },
      { name: "twitter:description", content: "TEXITcoin (TXC) is a Layer 1 cryptocurrency mined in Texas — sound money for a sovereign Lone Star State. Trade on Pionex, track on CoinMarketCap." },
