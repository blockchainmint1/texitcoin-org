...
export const SEARCH_ENTRIES: SearchEntry[] = [
  ...
  { label: "Watch Live", to: "/live", group: "Discover", keywords: "live stream tuesday thursday honest money hour watch", description: "Live Tuesdays & Thursdays at noon Central with Bobby Gray." },
  { label: "Zoom Call Archive", to: "/zoom", group: "Discover", keywords: "honest money hour live tuesday thursday", description: "Every Honest Money Hour call, with summaries and transcripts." },
