...
export const SEARCH_ENTRIES: SearchEntry[] = [
  ...
  { label: "Watch Live", to: "/live", group: "Discover", keywords: "live stream tuesday thursday honest money hour watch", description: "Live Tuesdays & Thursdays at 8pm Central with Bobby Gray." },
